...
Page({
    ...
    resolveSubject: function () {
        return __awaiter(this, void 0, void 0, function () {
            var subjectName, subjectId, meta, subjects, subject;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    loadStatsDetail: function (days) {
        return __awaiter(this, void 0, void 0, function () {
            var subject, data, view, repeatRate, mistakeRate, sortedTypes, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, api_1.api.getSubjectStatsDetail(subject, { days: days, source: 'mistakes' })];
                    case 2:
                        data = _a.sent();
