...
Page({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(this.data.activeTab === 'my')) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, api_1.api.getSharedBanks()];
                    case 4:
                        res = _a.sent();
                        banks = res.banks || [];
    ...
    onBankTap: function (e) {
        ...
        if (!bankId)
            return;
        wx.navigateTo({
            url: "/pages/bank-detail/bank-detail?id=".concat(bankId)
        });
    },
    onJoinTap: function () {
    ...
    onPullDownRefresh: function () {
        this.loadBanks().finally(function () { return wx.stopPullDownRefresh(); });
    }
});
