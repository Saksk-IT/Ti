...
function buildTrendPatch(res) {
    ...
    var heatmapAll = Array.isArray((_a = res === null || res === void 0 ? void 0 : res.activity_heatmap) === null || _a === void 0 ? void 0 : _a.all) ? res.activity_heatmap.all : [];
    ...
    onShow: function () {
        ...
        if (!this.data.inited) {
            try {
                ...
                if (cached) {
                    __assign(patch, buildTrendPatch(cached), { errorMsg: '' });
