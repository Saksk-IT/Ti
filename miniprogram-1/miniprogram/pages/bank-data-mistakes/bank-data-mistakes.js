...
Page({
    ...
    onLoad: function (options) {
        var _a, _b;
        var rawId = (_b = (_a = options === null || options === void 0 ? void 0 : options.id) !== null && _a !== void 0 ? _a : options === null || options === void 0 ? void 0 : options.bank_id) !== null && _b !== void 0 ? _b : options === null || options === void 0 ? void 0 : options.bankId;
        var bankId = Number(rawId || 0);
        var bankName = (options === null || options === void 0 ? void 0 : options.bank) ? String(options.bank) : (options === null || options === void 0 ? void 0 : options.name) ? String(options.name) : '';
        if (bankName) {
            try {
    ...
    onDetailTabTap: function (e) {
        ...
        var prevId = Number(((_c = prev === null || prev === void 0 ? void 0 : prev.data) === null || _c === void 0 ? void 0 : _c.bankId) || 0);
        var returnKey = "bank_".concat(bankId, "_return_tab");
        ...
        (0, nav_1.safeNavigate)("/pages/bank-detail/bank-detail?id=".concat(encodeURIComponent(String(bankId)), "&tab=").concat(encodeURIComponent(tab)), 'redirectTo');
    },
    onDataTabTap: function (e) {
        ...
        if (subtab === this.data.dataSubTab)
            return;
        var bankId = Number(this.data.bankId || 0);
        var bank = String(this.data.bankName || '').trim();
        var params = [];
        if (bankId)
            params.push("id=".concat(encodeURIComponent(String(bankId))));
        if (bank)
            params.push("bank=".concat(encodeURIComponent(bank)));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.resolveBank()];
                    case 2:
                        _a.sent();
    ...
    resolveBank: function () {
        return __awaiter(this, void 0, void 0, function () {
            var bankName, bankId, res, bankData, name, description;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        bankName = String(this.data.bankName || '').trim();
                    ...
                    case 1:
                        res = _a.sent();
                        bankData = (res === null || res === void 0 ? void 0 : res.data) || res || {};
                        name = String((bankData === null || bankData === void 0 ? void 0 : bankData.name) || '').trim();
                        description = String((bankData === null || bankData === void 0 ? void 0 : bankData.description) || '').trim();
                        this.setData({ bankName: name || "\u9898\u5E93".concat(bankId), bankDescription: description });
                        return [2 /*return*/];
                }
            });
        });
    ...
    buildStatsView: function (data) {
        ...
        var byType = rawByType.map(function (it) {
            ...
            return {
                ...
                metaText: "\u9519\u9898 ".concat(mis, " \u00B7 \u5DF2\u505A ").concat(a, "/").concat(t, " \u00B7 \u6B63\u786E\u7387 ").concat(acc.toFixed(1), "% \u00B7 \u8986\u76D6\u7387 ").concat(comp.toFixed(1), "%")
            };
        });
    ...
    loadStatsDetail: function (days) {
        return __awaiter(this, void 0, void 0, function () {
            var bankId, data, view, repeatRate, mistakeRate, sortedTypes, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        bankId = Number(this.data.bankId || 0);
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, api_1.api.getBankStatsDetail(bankId, { days: days, source: 'mistakes' })];
                    case 2:
                        data = _a.sent();
                        ...
                        sortedTypes = __spreadArray([], view.byType, true).sort(function (a, b) { return b.wrong - a.wrong; });
                        this.setData({
