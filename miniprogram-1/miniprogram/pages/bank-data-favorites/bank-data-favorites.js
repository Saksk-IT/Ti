...
Page({
    ...
    loadStatsDetail: function (days) {
        return __awaiter(this, void 0, void 0, function () {
            var bankId, data, view, activeDays, activeDaysRate, favMistakeRate, sortedTypes, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        bankId = Number(this.data.bankId || 0);
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, api_1.api.getBankStatsDetail(bankId, { days: days, source: 'favorites' })];
                    case 2:
                        data = _a.sent();
