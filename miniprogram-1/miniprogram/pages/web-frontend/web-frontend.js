...
Page({
    ...
    onLoad: function (options) {
        var next = (options && options.next ? String(options.next) : '').trim();
        if (next) {
    ...
    loadWebFrontend: function () {
        return __awaiter(this, void 0, void 0, function () {
            var res, origin, src, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, api_1.api.getMiniWebViewUrl(this.data.next || '/hub')];
                    case 2:
                        res = _a.sent();
                    ...
                    case 3:
                        err_1 = _a.sent();
                        console.error('加载 Web 前台失败:', err_1);
