...
Page({
    data: __assign(__assign({}, (theme_1.themeManager.getPageData())), { loading: false, inited: false, lazyStage: 1, errorMsg: '', ecLazy: { lazyLoad: true }, days: 30, window_days: 30, all_summary: {}, bank_summary: {}, total_questions: 0, answered_count: 0, accuracy: 0, window_answered: 0, window_accuracy: 0, subject_rows: [], bank_rows: [] }),
    onLoad: function (options) {
        var _this = this;
        var days = (0, data_center_1.normalizeDays)(options === null || options === void 0 ? void 0 : options.days);
        var url = "/packages/data/pages/data-center-v2/data-center-v2?tab=banks&days=".concat(encodeURIComponent(String(days)));
        wx.redirectTo({
            url: url,
            fail: function () {
    ...
    onShow: function () {
        ...
        if (!this.data.inited) {
            try {
                ...
                if (cached) {
                    var built = buildBankViewModel(cached, this.data.days);
                    var self = this;
    ...
    onTabTap: function (e) {
        ...
        var tab = raw === 'global' || raw === 'mistakes' || raw === 'favorites' || raw === 'tags' ? raw : 'banks';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        built = buildBankViewModel(res, this.data.days);
                        self.__dcPayload = built.payload;
