(function () {
  ...
  window.renderBankDefaultCover = function (title, label, fallbackTitle) {
    var coverTitle = String(title || fallbackTitle || '智能题库').trim() || '智能题库';
    var coverLabel = String(label || '默认封面').trim() || '默认封面';
    return '<div class="plaza-bank-cover-fallback" aria-hidden="true">' +
      ...
      '<div class="plaza-cover-copy">' +
        ...
        '<strong class="plaza-cover-title">' + esc(coverTitle) + '</strong>' +
