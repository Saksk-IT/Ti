...
- `openapi/phase4c-personal-bank-user-counts.openapi.json`：两条 user-counts GET 的自包含 OpenAPI 3.1.2 增量；历史文档保留 implemented-pending 捕获时点，当前 route successor 已晋级两条 GET，HEAD/OPTIONS 是派生语义且不增加 migrated operation。
