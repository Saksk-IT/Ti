...
/** Phase 2 boundary-context smoke test; this does not claim community behavior has migrated. */
@ApplicationModuleTest(mode = BootstrapMode.STANDALONE, webEnvironment = SpringBootTest.WebEnvironment.NONE)
@ActiveProfiles("unit")
class CommunityModuleContextTest extends AbstractPhase2ModuleContextTest {
    @Override
