...
var KEY_TAB = 'tags_bank_tab';
var KEY_KW = 'tags_bank_kw';
...
Page({
    ...
    onReviewTabTap: function (e) {
        var _a, _b;
        var kind = String(((_b = (_a = e === null || e === void 0 ? void 0 : e.currentTarget) === null || _a === void 0 ? void 0 : _a.dataset) === null || _b === void 0 ? void 0 : _b.kind) || '').trim();
        if (kind === 'mistakes') {
    ...
    onPublicBankTap: function (e) {
        ...
        if (!Number.isFinite(id) || id <= 0)
            return;
        var name = ((_d = (_c = e === null || e === void 0 ? void 0 : e.currentTarget) === null || _c === void 0 ? void 0 : _c.dataset) === null || _d === void 0 ? void 0 : _d.name) ? String(e.currentTarget.dataset.name) : '';
        var subjectName = name;
        if (!subjectName) {
            var hit = (this.data.subjects || []).find(function (s) { return Number((s === null || s === void 0 ? void 0 : s.id) || 0) === id; });
            subjectName = hit ? String(hit.name || '') : '';
        }
        if (!subjectName)
            return;
        var url = "/pages/review-center-v2/review-center-v2?kind=tags&subject=".concat(encodeURIComponent(subjectName));
    ...
    onBankTap: function (e) {
        ...
        if (!Number.isFinite(id) || id <= 0)
            return;
        var url = "/pages/review-center-v2/review-center-v2?kind=tags&bank_id=".concat(encodeURIComponent(String(id)));
        (0, nav_1.safeNavigate)(url, 'navigateTo');
    },
