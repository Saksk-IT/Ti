...
Page({
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, api_1.api.miniSendForgotPasswordCode(email)];
                    case 2:
                        _a.sent();
                    ...
                    case 3:
                        e_1 = _a.sent();
                        wx.showToast({ title: (e_1 && (e_1.message || e_1.errMsg)) || '发送失败', icon: 'none' });
                        return [3 /*break*/, 4];
    ...
    onResetTap: function () {
        return __awaiter(this, void 0, void 0, function () {
            var email, code, newPassword, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, api_1.api.miniResetPassword(email, code, newPassword)];
                    case 2:
                        _a.sent();
                    ...
                    case 3:
                        e_2 = _a.sent();
                        wx.showToast({
                            title: (e_2 && (e_2.message || e_2.errMsg)) || '重置失败',
                            icon: 'none'
                        });
