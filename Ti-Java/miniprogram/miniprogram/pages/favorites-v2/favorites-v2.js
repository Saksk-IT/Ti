...
var KEY_TAB = 'favorites_bank_tab';
var KEY_KW = 'favorites_bank_kw';
...
Page({
    ...
    onPublicBankTap: function (e) {
        ...
        if (!name)
            return;
        var url = "/pages/review-center-v2/review-center-v2?kind=favorites&subject=".concat(encodeURIComponent(name));
    ...
    onBankTap: function (e) {
        ...
        if (!Number.isFinite(id) || id <= 0)
            return;
        var url = "/pages/review-center-v2/review-center-v2?kind=favorites&bank_id=".concat(encodeURIComponent(String(id)));
        (0, nav_1.safeNavigate)(url, 'navigateTo');
    },
