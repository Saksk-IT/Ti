...
var CHART_IDS = ['dcTagGraphChart', 'dcTagTreemapChart', 'dcTagTopChart', 'dcTagAccuracyChart'];
Page({
    data: __assign(__assign({}, (theme_1.themeManager.getPageData())), { loading: false, inited: false, lazyStage: 1, errorMsg: '', ecLazy: { lazyLoad: true }, days: 30, window_days: 30, tags_kpis: {
            all_tag_count: 0,
            public_tag_count: 0,
            banks_tag_count: 0,
        ...
        }, health_score: 0, tags_public: [], tags_banks: [] }),
    ...
    onShow: function () {
        ...
        if (!this.data.inited) {
            try {
                ...
                if (cached) {
                    var built = buildTagsViewModel(cached, this.data.days);
                    var self = this;
    ...
    onTabTap: function (e) {
        ...
        var tab = raw === 'global' || raw === 'banks' || raw === 'mistakes' || raw === 'favorites' ? raw : 'tags';
    ...
    onGoTagCenterPublic: function (e) {
        ...
        var url = "/pages/tags-v2/tags-v2?tab=public&keyword=".concat(encodeURIComponent(tag));
        (0, nav_1.safeNavigate)(url, 'redirectTo');
    },
    onGoTagCenterBanks: function (e) {
        var _a, _b;
        var tag = String(((_b = (_a = e === null || e === void 0 ? void 0 : e.currentTarget) === null || _a === void 0 ? void 0 : _a.dataset) === null || _b === void 0 ? void 0 : _b.tag) || '').trim();
        var url = "/pages/tags-v2/tags-v2?tab=bank&keyword=".concat(encodeURIComponent(tag));
        (0, nav_1.safeNavigate)(url, 'redirectTo');
    },
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        built = buildTagsViewModel(res, this.data.days);
                        self.__dcPayload = built.payload;
