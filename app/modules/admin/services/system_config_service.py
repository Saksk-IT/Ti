...
class SystemConfigService:
    ...
    def get_edu_schedule_config() -> Dict[str, Any]:
        ...
        return {
            ...
            'grade_path': str(SystemConfigService._get_plain_config_value('edu_schedule_grade_path', 'EDU_SCHEDULE_GRADE_PATH', '/cjcx/cjcx_cxXsgrcj.html?doType=query&gnmkdm=N305005') or '').strip(),
    ...
    def save_edu_schedule_config(data: Dict[str, Any], admin_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        plain_fields = {
            ...
            'edu_schedule_grade_path': str(data.get('grade_path') or '/cjcx/cjcx_cxXsgrcj.html?doType=query&gnmkdm=N305005').strip(),
        ...
        descriptions = {
            ...
            'edu_schedule_grade_path': '个人成绩接口路径',
